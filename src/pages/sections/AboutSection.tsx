  ...
  return (
    <section className="flex flex-col w-full items-center gap-12 md:gap-[78px] py-12 px-6 overflow-hidden">
      ...
      <div className="flex flex-col items-start gap-8 md:gap-[7px] w-full max-w-[1297px]">
        <div className={`flex flex-col lg:flex-row items-start justify-center gap-12 lg:gap-[65px] w-full ${isRTL ? "lg:flex-row-reverse" : ""}`}>
          <div className={`w-full lg:w-[574px] gap-8 md:gap-[42px] flex flex-col items-center lg:items-start text-center lg:text-left ${isRTL ? "lg:items-end lg:text-right" : ""}`}>
            ...
            <div className={`flex flex-col w-full max-w-[349px] items-center lg:items-start gap-6 md:gap-[33px] ${isRTL ? "lg:items-end" : ""}`}>
              {contactInfo.map((item, index) => (
                <div
                  key={index}
                  className={`flex items-center gap-4 md:gap-[19px] w-full ${isRTL ? "flex-row-reverse" : ""}`}
                >
                  <img
              ...
              <div className="flex flex-col w-full items-start gap-4">
                <div className="relative w-full">
                  <Input
                    ...
                    className={`w-full h-14 md:h-[67px] bg-white rounded-lg border border-solid border-[#d7d7d7] px-4 md:px-[27px] [font-family:'Roboto',Helvetica] font-normal text-text-color text-base md:text-[21px] ${isRTL ? "text-right" : ""}`}
                    dir={isRTL ? "rtl" : "ltr"}
                  />
                  <span className={`absolute top-4 md:top-[21px] ${isRTL ? "right-20 md:right-[95px]" : "left-20 md:left-[95px]"} [font-family:'Montserrat',Helvetica] font-normal text-red text-base md:text-lg`}>
                    *
                  </span>
                </div>
                ...
                <div className="relative w-full">
                  <Input
                    ...
                    dir={isRTL ? "rtl" : "ltr"}
                  />
                  <span className={`absolute top-4 md:top-[15px] ${isRTL ? "right-28 md:right-[150px]" : "left-18 md:left-[91px]"} [font-family:'Montserrat',Helvetica] font-normal text-red text-base md:text-lg`}>
                    *
                  </span>
                </div>
                ...
                <div className="relative w-full">
                  <Textarea
                    ...
                    className={`w-full h-40 md:h-[209px] bg-white rounded-lg border border-solid border-[#d7d7d7] px-4 md:px-[27px] py-4 md:py-[21px] [font-family:'Roboto',Helvetica] font-normal text-text-color text-base md:text-[21px] resize-none ${isRTL ? "text-right" : ""}`}
                    dir={isRTL ? "rtl" : "ltr"}
                  />
                </div>

                <Button className={`w-full h-14 md:h-[68px] bg-[#2a24a3] hover:bg-[#2a24a3]/90 rounded-[110px] flex items-center justify-center gap-2.5 [font-family:'Montserrat',Helvetica] font-medium text-[#ffffff] text-lg md:text-[21px] ${isRTL ? "flex-row-reverse" : ""}`}>
                  {t("contact.submit")}
