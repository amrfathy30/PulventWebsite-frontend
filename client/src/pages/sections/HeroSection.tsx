...
export const HeroSection = (): JSX.Element => {
  return (
    <section className="w-full relative overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-11 px-6 md:px-12 py-10 md:py-14 items-center md:items-start text-center md:text-left">
        <div className="flex flex-col items-center md:items-start gap-6 md:gap-11 w-full md:w-[603px]">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-[25px]">
            <Button className="w-full sm:w-auto bg-[#2a24a3] hover:bg-[#2a24a3]/90 text-[#ffffff] rounded-[110px] h-11 md:h-12 lg:h-[55px] px-6 md:px-4 [font-family:'Montserrat',Helvetica] font-medium text-base md:text-lg lg:text-[21px] gap-2">
              Get Started
              <img
                className="w-5 h-5 md:w-6 md:h-6 lg:w-[29px] lg:h-[29px]"
                alt="Iconoir arrow up"
                src="/figmaAssets/iconoir-arrow-up-circle.svg"
              />
            </Button>

            <Button className="w-full sm:w-auto bg-[#1babc6] hover:bg-[#1babc6]/90 text-[#ffffff] rounded-[110px] h-11 md:h-12 lg:h-[55px] px-6 md:px-4 [font-family:'Montserrat',Helvetica] font-medium text-base md:text-lg lg:text-[21px] gap-2">
              Our Services
              <img
                className="w-5 h-5 md:w-6 md:h-6 lg:w-[29px] lg:h-[29px]"
                alt="Iconoir arrow up"
